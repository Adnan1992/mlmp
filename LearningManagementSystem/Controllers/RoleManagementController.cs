...
namespace LearningManagementSystem.Controllers
{
    ...
    public class RoleManagementController : BaseSecurityController
    {
        public ActionResult Index()
        {
            ...
            ViewBag.Users = db.Users.OrderBy(u => u.FirstName).ToList().Select(uu =>
            new SelectListItem { Value = uu.FirstName.ToString(), Text = uu.FirstName }).ToList();
        ...
        public async Task<ActionResult> RoleAddToUser(string UserName, string RoleName)
        {
            ...
            var user = db.Users.Where
                (u => u.FirstName.Equals(UserName, StringComparison.CurrentCultureIgnoreCase)).FirstOrDefault();
            ...
            var userlist = db.Users.OrderBy(u => u.FirstName).ToList().Select(uu =>
            new SelectListItem { Value = uu.FirstName.ToString(), Text = uu.FirstName+" "+uu.LastName }).ToList();
        ...
        public async Task<ActionResult> GetRoles(string UserName)
        {
            ...
            {
                var user = db.Users.Where(u => u.FirstName.Equals
        ...
        public async Task<ActionResult> DeleteRoleForUser(string UserName, string RoleName)
        {
            ...
            //var context = new Models.ApplicationDbContext();
            var user = db.Users.Where(u => u.FirstName.Equals(UserName, StringComparison.CurrentCultureIgnoreCase)).FirstOrDefault();
