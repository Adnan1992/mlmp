...
namespace LearningManagementSystem
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            {
                From = new MailAddress("no_reply@microtechx.org", "MicrotechX Technologies"),
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<LMSContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            var store = new RoleStore<IdentityRole>(context.Get<LMSContext>());
